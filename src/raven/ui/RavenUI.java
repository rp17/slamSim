...
public class RavenUI extends JFrame implements KeyListener, MouseInputListener, ComponentListener {
	...
	private void createMenu() {
		...
		//TODO: add menu items for landmarks
		menuItem = new JMenuItem("Add landmark");
	    menuItem.addActionListener(new ActionListener() {
			@Override public void actionPerformed(ActionEvent e) {
				if(popupLoc != null) game.addLandmarkAt(popupLoc);
				System.out.println("Added landmark at " + popupLoc.x + " " + popupLoc.y);
			}
		});
	    popup.add(menuItem);
	    
	    menuItem = new JMenuItem("Clear landmarks");
	    menuItem.addActionListener(new ActionListener() {
	    	@Override public void actionPerformed(ActionEvent e) {
				game.clearLandmarks();
			}
	    ...
	    menuItem = new JMenuItem("Plot EFK Slam Path");
	    menuItem.addActionListener(new ActionListener() {
	    	@Override public void actionPerformed(ActionEvent e) {
